...
def main():
    ...
    plt.savefig('Figures/Full_contrast_30_30_30_100_iter_std_dev.pdf', dpi=400, bbox_inches='tight')
    plt.show()

    # Save the final results dictionary
    np.save('Spontaneous_Spike_Data/Full_contrast_30_30_30_100_iter_std_dev.npy', final_results)
